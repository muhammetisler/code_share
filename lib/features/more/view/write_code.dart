...
import 'package:auth_app/common/constants.dart';
...
class WriteCode extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WriteCode> createState() => _WriteCodeState();
}

class _WriteCodeState extends ConsumerState<WriteCode> {
  XFile? image;
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    ref
                        ...
                        .storageFileToFirebase(
                            "codes/${user.uid}/${DateTime.now().microsecondsSinceEpoch}",
                            File(image!.path))
                        .then((value) {
